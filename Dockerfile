...
RUN \
    curl -L https://github.com/sharkdp/bat/releases/download/v0.9.0/bat-v0.9.0-x86_64-unknown-linux-gnu.tar.gz | tar -C /usr/local/src -zxf - &&\
    ln -s /usr/local/src/bat-v0.9.0-x86_64-unknown-linux-gnu/bat /usr/local/bin/bat
